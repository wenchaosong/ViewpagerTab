...
import com.ms.tab.listener.OnTabSelectListener;
import com.ms.tab.utils.FragmentChangeManager;
import com.ms.tab.utils.UnreadMsgUtils;
import com.ms.tab.widget.MsgView;
...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mSelStrokeColor = ta.getColor(R.styleable.SegmentTabLayout_tl_bar_select_stroke_color, mIndicatorColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mIndicatorDrawable.setStroke((int) mBarStrokeWidth, mSelStrokeColor);
